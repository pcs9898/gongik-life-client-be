...
public class GlobalControllerAdvice {
    ...
    public ResponseEntity<?> handleInternalAuthenticationServiceException(
        ...
        return ResponseEntity.status(ErrorCode.EMAIL_NOT_FOUND.getStatus())
                .body(Response.error(ErrorCode.EMAIL_NOT_FOUND.getMessage()));
    ...
    public ResponseEntity<?> handleAllExceptions(Exception e) {
        ...
        return ResponseEntity.status(ErrorCode.INTERNAL_SERVER_ERROR.getStatus())
                .body(Response.error(e.getLocalizedMessage()));
    }
